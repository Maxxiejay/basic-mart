<template>
    <footer class="bg-[#134e4a] mt-10 text-white">
      <!-- Main Footer Content -->
      <div class="container mx-auto px-4 py-8">
        <!-- Company Info -->
        <div class="flex flex-col items-center text-center">
          <h3 class="font-bold text-lg mb-3">BasicMart</h3>
          <p class="text-gray-200 text-sm mb-4 max-w-md">
            Your one-stop shop for fresh groceries and household essentials delivered to your doorstep.
          </p>
          <div class="flex space-x-6 mb-4">
            <a href="#" class="text-gray-200 hover:text-white hover:scale-110 transition-transform">
          ...
          <p class="text-sm text-gray-300">© 2023 BasicMart. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </template>
